...
local new_pos = REAPI:basicGreedyForgetfulNoCollisionPathfindToward(spriteXPos, spriteYPos, spriteZPos, REAPI:get_player_pos_x(), REAPI:get_player_pos_y(), REAPI:get_player_pos_z(), 0.1)
