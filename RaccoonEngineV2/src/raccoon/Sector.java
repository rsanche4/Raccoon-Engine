...
public class Sector {
    ...
    public Sector(int ID, int floor_height, int ceil_height, String floor_texture, int floor_brightness, boolean floor_tiled, boolean floor_skip_texture, String ceil_texture, int ceil_brightness, boolean ceil_tiled, boolean ceil_skip_texture) {
        this.ID = ID;
